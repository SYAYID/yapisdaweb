...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('smp_applicants')) {
            Schema::create('smp_applicants', function (Blueprint $table) {
                $table->id();
                $table->string('registration_number')->unique();
                $table->string('kk_area');
                ...
                $table->text('parent_ktp_city')->nullable();
    ...
    {
        Schema::dropIfExists('smp_applicants');
    }
};
