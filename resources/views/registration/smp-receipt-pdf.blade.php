...
<body>
    <table style="width: 100%; border-bottom: 3px double #000; padding-bottom: 10px; margin-bottom: 20px;">
        <tr>
            <td style="width: 15%; text-align: left; vertical-align: middle; padding: 0;">
                <img src="{{ public_path('images/logo-smp.png') }}" style="max-height: 60px; max-width: 60px;">
            </td>
            <td style="width: 70%; text-align: center; vertical-align: middle; padding: 0;">
                ...
                <h2 style="margin: 2px 0; font-size: 13px; font-weight: bold; font-family: sans-serif; color: #1e40af; line-height: 1.2;">SMPS YAPISDA CISOKA</h2>
    ...
    <div class="border-bottom">
        <table>
            ...
            <tr>
                <td class="col-label">Program</td>
                <td class="col-value">: {{ $applicant->school_program }}</td>
            </tr>
            <tr>
