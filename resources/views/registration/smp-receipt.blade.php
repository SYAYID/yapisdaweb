    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-8 text-center">
                            ...
                            <h5 class="fw-bold mb-1" style="font-family: 'Times New Roman', Times, serif; font-size: 13pt; color: #1e40af;">SMPS YAPISDA CISOKA</h5>
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-4"><small><strong>Program Sekolah</strong></small></div>
                        <div class="col-8"><small>: {{ $applicant->school_program }}</small></div>
                    </div>
            ...
            <div class="text-center mt-4">
                ...
                <a href="{{ route('registration.smp-receipt.pdf', $applicant->id) }}" class="btn btn-danger me-2">
                ...
                <a href="{{ route('registration.smp-form') }}" class="btn btn-success">
