...
<div class="guide-container">
    ...
    <div class="guide-hero">
        ...
        <div class="guide-hero-text">
            <h3>Panduan Alur Kerja Admin SMKS</h3>
            <p>Selamat datang di Pusat Bantuan Admin SMKS YAPISDA. Halaman ini menjelaskan seluruh fungsi menu, alur verifikasi berkas calon peserta didik baru tingkat SMK, serta ketentuan kuota program keahlian secara detail dan prosedural.</p>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="guide-flow">
            ...
            <div class="guide-flow-step">
                ...
                <p>Klik tombol <strong>Lihat Berkas</strong> (ikon folder) untuk mengecek kelengkapan file upload (KK, Ijazah, SKL, dll.) serta validitas NIK pendaftar.</p>
            </div>
            <div class="guide-flow-step">
        ...
        <div class="guide-menu-grid">
            ...
            <div class="guide-menu-card">
                ...
                <div class="guide-menu-info">
                    ...
                    <p>Memuat visualisasi grafik tren harian pendaftaran, rasio status verifikasi pendaftar, grafik sebaran peminat jurusan, serta Heatmap Jam & Hari tersibuk untuk analisa efisiensi tim.</p>
                    <div class="guide-badge-list">
            ...
            <div class="guide-menu-card">
                ...
                <div class="guide-menu-info">
                    <h5>Kuota Jurusan</h5>
                    <p>Menampilkan kapasitas maksimum, jumlah kuota terpakai, dan sisa kuota masing-masing jurusan SMK. Dilengkapi bar presentase keterisian kuota secara langsung.</p>
                    <div class="guide-badge-list">
                        <span>Kapasitas</span>
            ...
            <div class="guide-menu-card">
                ...
                <div class="guide-menu-info">
                    ...
                    <p>Modul kerja utama admin untuk mencari, menyaring (berdasarkan status/jurusan), mengecek file unggahan berkas, mencetak ulang formulir bukti pendaftaran, serta melakukan verifikasi akhir.</p>
                    <div class="guide-badge-list">
    ...
    <div class="guide-notice-box">
        ...
        <div class="guide-notice-content">
            <h5>Ketentuan Kuota Jurusan Secara Otomatis (Sistem Terintegrasi)</h5>
            <p>Sistem YAPISDA dilengkapi dengan fitur pengurangan kuota otomatis. Kuota jurusan <strong>hanya akan berkurang</strong> jika Anda mengubah status pendaftar menjadi <strong>Verified</strong>. Apabila status diubah kembali menjadi <em>Pending</em> atau <em>Rejected</em>, kuota jurusan yang terpakai akan otomatis dikembalikan secara real-time. Pastikan kuota jurusan masih tersedia sebelum melakukan verifikasi.</p>
        </div>
    </div>
</div>
