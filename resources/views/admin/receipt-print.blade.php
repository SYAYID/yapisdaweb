    ...
    <div class="receipt-container">
        ...
        <div class="header">
            ...
            <div class="school-info">
                ...
                <h2 style="font-family: 'Times New Roman', Times, serif; font-size: 13pt; margin: 2px 0; line-height: 1.2;">SMKS YAPISDA CISOKA</h2>
        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item"><span class="label">Program Pilihan</span><span class="colon">:</span><span class="value highlight">{{ $applicant->major_choice }}</span></div>
                </div>
            </div>
        ...
        <div class="footer">
            ...
            <div class="signature">
                <div class="signature-item">
                    ...
                    <div class="signature-role">Panitia PPDB SMKS YAPISDA</div>
